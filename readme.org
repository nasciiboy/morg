...
*** resaltar texto
    ...
    lenguaje de progracamion como c, o lips, donde los nombres de las
    funciones contienen marcas segnificativas al lenguaje como =char
    **furcion( int** a)= o =funcion_a_b_c_algo= que en caso de org el
    '_' se interpreta como un subindice, o al documentar sobre emacs
    donde =*scratch*= represenda el nobre de un bufer y no una palabra
    resaltada en bold terdria resultados no desados, sin mencianar que
    resaltar un elemento con mas de dos etiquetas es cuando menos,
    ademas de que pocas marcas pueden tenerse antes de comenzar a
    tener que utiliza signos poco habituales.
